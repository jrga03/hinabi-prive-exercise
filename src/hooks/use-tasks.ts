...
import type { CreateTaskInput, ReorderTaskUpdate, Task, UpdateTaskInput } from "@/lib/types";
...
export function useUpdateTask(): UseMutationResult<Task, Error, UpdateTaskVars, TaskListContext> {
  const qc = useQueryClient();
...
export function useReorderTasks(): UseMutationResult<void, Error, ReorderVars, TaskListContext> {
  const qc = useQueryClient();
...
export function useDeleteTask(): UseMutationResult<void, Error, DeleteTaskVars, TaskListContext> {
  const qc = useQueryClient();
